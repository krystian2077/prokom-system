      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-20">
        <div className="text-center">
          ...
          <h2 className="text-4xl font-bold leading-tight tracking-tight text-[#0d0d0d] sm:text-5xl lg:text-[3rem]">
            Folie dla{" "}
            <span className="not-italic text-[#dc1e1e]">każdego urządzenia</span>
          </h2>
        ...
        <div className="mx-auto mt-20 grid max-w-[1000px] grid-cols-1 gap-7 sm:grid-cols-3">
          {cards.map((card) => (
            <div
              key={card.title}
              className="flex cursor-pointer items-center gap-7 rounded-[22px] border border-[rgba(0,0,0,0.07)] bg-[#fafafa] px-7 py-7.5 no-underline transition-all duration-200 hover:-translate-y-1 hover:border-[rgba(220,30,30,0.25)] hover:shadow-[0_10px_32px_rgba(0,0,0,0.08)]"
            >
              <div className="flex h-[88px] w-[88px] flex-shrink-0 items-center justify-center rounded-[24px] border border-[rgba(0,0,0,0.08)] bg-white/90">
                <Image
                  src={card.image}
                  alt={card.alt}
                  width={84}
              ...
              <div>
                ...
                <p className="mt-1.5 text-[14px] text-[#777]">{card.desc}</p>
              </div>
            </div>
          ))}
        </div>
