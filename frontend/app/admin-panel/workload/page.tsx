  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-6xl flex-col gap-6 px-4 py-8">
      <header>
        ...
        <h1 className="mt-2 text-2xl font-semibold text-[var(--white)]">Workload</h1>
        <p className="mt-1 text-sm text-[var(--ink2)]">Obciążenie zespołu, dostępność i health score.</p>
      </header>
