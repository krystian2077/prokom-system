...
export default function KontaktPage() {
  ...
  return (
    <div role="main" className="min-h-[100vh] w-full font-sans bg-[#f4f4f5]">
      {/* SEKCJA 1 — Dark Hero */}
      <section className="relative overflow-hidden bg-[#0d0e10] py-16 sm:py-20">
        {/* red glow */}
        <div
          className="pointer-events-none absolute -right-20 -top-28 h-[600px] w-[600px]"
          style={{
            background:
        ...
        <div className="relative mx-auto flex max-w-[1240px] flex-col gap-14 px-6 py-8 sm:px-10 lg:grid lg:grid-cols-[1fr_auto] lg:items-center lg:gap-20 xl:px-0">
          {/* Left column */}
          <div className="space-y-8">
            <p className="font-sans text-[11px] font-medium uppercase tracking-[0.2em] text-[#4b5563]">
              PRO-KOM{" "}
            ...
            <p className="max-w-[440px] font-sans text-[16px] leading-[1.75] text-[#9ca3af]">
          ...
          <div className="flex flex-col items-stretch gap-4 sm:items-end">
            {/* Status pill */}
            <div className="inline-flex min-w-0 max-w-full flex-wrap items-center gap-2 rounded-full border border-white/10 bg-white/5 px-5 py-2.5 font-sans text-[13px] sm:flex-nowrap">
            ...
            <div className="flex flex-col gap-3 sm:w-[280px]">
              <Link
                href="tel:883200151"
                className="group flex items-center gap-4 rounded-2xl border border-white/10 bg-[#13151a] px-5 py-4 font-sans transition-all duration-200 hover:-translate-x-1 hover:border-[rgba(220,30,30,.35)] hover:bg-[rgba(220,30,30,.08)]"
              >
                <div className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl bg-[rgba(220,30,30,.12)] text-[#dc1e1e] transition-all duration-200 group-hover:bg-[#dc1e1e] group-hover:text-white group-hover:scale-105">
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-0.5 text-[15px] font-bold tracking-tight text-white break-all">
                    sklep@pro-kom.eu
                  </p>
                </div>
              </Link>
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-10">
        ...
        <div className="flex justify-center">
          <span className="inline-flex items-center gap-2 rounded-full bg-[#dc1e1e] px-4 py-1.5 text-[11px] font-semibold uppercase tracking-[0.1em] text-white">
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          <Link
            href="tel:883200151"
            className="group relative flex flex-col rounded-[22px] border border-[#eaeaea] bg-white px-[26px] py-[24px] shadow-[0_2px_8px_rgba(0,0,0,.05),0_6px_24px_rgba(0,0,0,.06)] transition-transform duration-200 hover:-translate-y-[6px] hover:border-[rgba(220,30,30,.2)]"
          >
            <div className="pointer-events-none absolute inset-x-0 top-0 h-[3px] origin-left scale-x-0 bg-[#dc1e1e] opacity-80 transition-transform duration-300 group-hover:scale-x-100" />
            <div className="flex h-[50px] w-[50px] items-center justify-center rounded-[14px] border border-[rgba(220,30,30,.15)] bg-[#fff0f0] text-[#dc1e1e] transition-all duration-200 group-hover:bg-[#dc1e1e] group-hover:text-white group-hover:-rotate-3 group-hover:scale-[1.06]">
              <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden="true">
                <path
                  d="M6.5 4.5A2 2 0 0 1 8.4 3h2.2c.9 0 1.6.6 1.8 1.4l.5 2.3a2 2 0 0 1-.6 1.9l-1 1a10.5 10.5 0 0 0 4.3 4.3l1-1a2 2 0 0 1 1.9-.6l2.3.5c.8.2 1.4.9 1.4 1.8v2.2a2 2 0 0 1-1.5 1.9c-2.1.5-6.6.4-10.6-3.6S3 8.6 3.5 6.5A2 2 0 0 1 5.4 5l1.1-.5Z"
                  fill="currentColor"
            ...
            <p className="mt-5 text-[11px] font-semibold uppercase tracking-[0.08em] text-[#bbbbbb]">
              Telefon
            </p>
            <p
              className="mt-1 font-bold text-[#0d0d0d] tracking-tight"
              style={{ fontSize: "clamp(15px,1.7vw,21px)" }}
            >
              883 200 151
            </p>
            <p className="mt-2 text-[13px] text-[#777]">
              Odpowiadamy od ręki podczas godzin otwarcia. Zadzwoń — pomożemy.
            </p>
          </Link>
          ...
          >
            ...
            <p className="mt-2 text-[13px] text-[#777]">
              Odpisujemy tego samego dnia roboczego. Opisz usterkę — wycenimy
              bezpłatnie.
            </p>
          </Link>
          ...
          >
            ...
            <p className="mt-2 text-[13px] text-[#777]">
              34-700 · woj. małopolskie · bezpłatny parking przy lokalu
            </p>
            <div className="mt-3 inline-flex items-center gap-2 rounded-full bg-[rgba(34,197,94,.08)] px-3 py-1 text-[11px] font-medium text-[#16a34a]">
        ...
        {/* Map card */}
        <div className="mt-6">
          <div className="overflow-hidden rounded-[22px] border border-[#eaeaea] bg-white shadow-[0_2px_8px_rgba(0,0,0,.05),0_6px_24px_rgba(0,0,0,.06)] transition-transform duration-200 hover:-translate-y-[4px] hover:border-[rgba(220,30,30,.18)]">
            ...
            <div className="flex items-center justify-between border-t border-[#eaeaea] px-[22px] py-4 text-[13px]">
              <div>
              ...
              <div className="flex gap-2">
                <Link
                  ...
                  target="_blank"
                  className="rounded-full border border-[#eaeaea] px-4 py-1.5 text-[12px] font-medium text-[#6b7280]"
                >
                  Mapy
                </Link>
                <Link
                  href="https://www.google.com/maps/dir/?api=1&destination=Orkana+16B,+34-700+Rabka-Zdr%C3%B3j"
                  target="_blank"
                  className="rounded-full bg-[#dc1e1e] px-4 py-1.5 text-[12px] font-semibold text-white shadow-[0_3px_12px_rgba(220,30,30,.28)]"
                >
                  Nawiguj
                </Link>
              </div>
      ...
      <section className="relative overflow-hidden bg-[#0d0e10] px-4 py-14 sm:px-8 lg:px-10">
        <div
          className="pointer-events-none absolute -right-16 -top-20 h-[400px] w-[400px]"
          style={{
            background:
        ...
        <div className="relative mx-auto max-w-[1240px]">
          <div className="mb-9 flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
            <h2
            ...
            <div className="inline-flex items-center gap-3 rounded-full border border-[rgba(34,197,94,.2)] bg-[rgba(34,197,94,.08)] px-4 py-2 text-[12px]">
      ...
      <section className="relative overflow-hidden bg-[#0d0e10] px-4 pb-16 pt-0 sm:px-8 lg:px-10">
        <div
          className="pointer-events-none absolute -bottom-24 -left-20 h-[500px] w-[500px]"
          style={{
            background:
              "radial-gradient(ellipse, rgba(220,30,30,.07), transparent 65%)",
          }}
          aria-hidden
        />
        <div className="relative mx-auto max-w-[1240px] pt-14">
          {/* CTA banner */}
          <div className="relative overflow-hidden rounded-[22px] border border-[rgba(255,255,255,.07)] bg-[#13151a] px-6 py-8 sm:px-10 sm:py-11 lg:flex lg:items-center lg:justify-between lg:gap-10">
            ...
            <div className="mt-6 flex flex-col gap-2 sm:flex-row sm:items-center lg:mt-0 lg:flex-col lg:items-end">
              <Link
                href="/zgloszenie"
                className="inline-flex items-center gap-2 rounded-[14px] bg-[#dc1e1e] px-7 py-3 text-[13px] font-bold text-white shadow-[0_4px_18px_rgba(220,30,30,.35),0_8px_32px_rgba(220,30,30,.2)] transition-transform duration-150 hover:-translate-y-[2px]"
              >
                <svg
                  viewBox="0 0 24 24"
                  className="h-4 w-4"
              ...
              <Link
                href="tel:883200151"
                className="inline-flex items-center gap-1.5 rounded-[14px] border border-[rgba(255,255,255,.08)] px-6 py-2.5 text-[13px] font-semibold text-[#555] transition-colors duration-150 hover:border-[rgba(255,255,255,.18)] hover:text-[#aaa]"
              >
          ...
          <div className="mt-12 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div
                key={item.label}
                className="rounded-[18px] border border-[rgba(255,255,255,.06)] bg-[#13151a] px-[22px] py-6 text-left text-[13px] transition-all duration-200 hover:-translate-y-[3px] hover:border-[rgba(220,30,30,.2)] hover:bg-[#1a1d23]"
              >
                <div
                  className="font-bold tracking-tight text-white"
